    ...
    const features = [
        {
            ...
            description:
                "Dijkstra algorithm computes the shortest paths in real-time for efficient waste collection.",
        },
        {
            icon: MapPin,
            title: "Interactive Mapping",
            description:
                "Visualize collection points, routes, and real-time operations on an interactive map.",
        },
        {
            icon: BarChart3,
            title: "Smart Analytics",
            description:
                "Weather data and citizen reports dynamically adjust route weights for optimal planning.",
        },
        {
            icon: Shield,
            title: "Role-Based Access",
            description:
                "Secure portals for administrators, field operators, and citizens with tailored permissions.",
        },
    ];
