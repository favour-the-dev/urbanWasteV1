                        ...
                        <div className="space-y-8">
                            <div className="space-y-4">
                                ...
                                <p className="text-xl text-gray-700 leading-relaxed">
                                    Be part of the solution for cleaner, more
                                    efficient waste management in Port Harcourt.
                                </p>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 backdrop-blur-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm">
                                            Manage operations, optimize routes,
                                            and oversee the entire waste
                                            management system.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 backdrop-blur-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm">
                                            Execute collection routes, update
                                            statuses, and ensure efficient waste
                                            collection.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 backdrop-blur-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm">
                                            Report issues, track requests, and
                                            help keep your community clean and
                                            organized.
                                        </p>
                                    </div>
                                </div>
