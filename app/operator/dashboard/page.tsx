...
export default function OperatorDashboard() {
  ...
  const onStatus = async (status: "active" | "completed") => {
    ...
    try {
      ...
      // Refresh route data
      const operatorId = (session as any)?.user?.id;
      const r = await fetch(`/api/operator/route?operatorId=${operatorId}`);
      ...
      {route ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {node.coordinates[0]?.toFixed(4)},{" "}
                          {node.coordinates[1]?.toFixed(4)}
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">
            You don't have any routes assigned at the moment. Contact your
            administrator for route assignment.
          </p>
