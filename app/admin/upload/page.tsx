  ...
  const onUpload = async () => {
    ...
    try {
      const res = await fetch("/api/admin/upload", {
        ...
        body: JSON.stringify({ nodes: uploadedNodes, edges: uploadedEdges }),
      });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Create and manage nodes and edges data for route optimization
          </p>
        </div>
      </div>
        ...
        {!summary && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Start by creating collection points and route connections for your
      ...
      {summary && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Nodes Detected</p>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Edges Detected</p>
                <p className="text-2xl font-bold text-gray-900">
                  {summary.edges}
                </p>
              </div>
        ...
        <Card className="p-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-sm text-gray-600">
              This will save {summary.nodes} nodes and {summary.edges} edges to
              the database
            </div>
          </div>
        </Card>
